...
export default function Library() {
  ...
  const resources = [
    ...
    { 
      id: 2,
      title: "Patent Search Techniques",
      category: "patents",
      icon: "🔍",
      description: "How to effectively search for existing patents",
      level: "Intermediate",
      progress: 30,
      timeToComplete: "35 min",
      tags: ["Research", "Prior Art", "Database"]
    },
    { 
      id: 3,
    ...
    { 
      ...
      category: "trademarks",
      icon: "🌐",
      description: "Protecting your trademark globally",
      level: "Advanced",
      progress: 10,
      timeToComplete: "60 min",
      tags: ["Global", "Madrid Protocol", "Strategy"]
    },
    { 
      id: 5,
    ...
    { 
      ...
      category: "copyright",
      icon: "⚖️",
      description: "Understanding fair use exceptions to copyright",
      level: "Intermediate",
      progress: 20,
      timeToComplete: "40 min",
      tags: ["Legal", "Exceptions", "Content Creation"]
    },
    { 
      id: 7,
    ...
    { 
      id: 8,
      title: "Patent Examination Process",
      category: "patents",
      icon: "⚖️",
      description: "Understanding how patents are evaluated",
      level: "Intermediate",
      progress: 25,
      timeToComplete: "50 min",
      tags: ["USPTO", "Prosecution", "Claims"]
    }
  ];
                ...
                >
                  ...
                  >
                    {resource.progress === 0 ? "Start Learning" : 
                     resource.progress === 100 ? "Review Again" : "Continue"}
                  </motion.button>
                </motion.div>
              ))}
            </AnimatePresence>
